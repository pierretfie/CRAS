  ...
  return (
    <div className="space-y-4 flex flex-col min-h-0">
      ...
      <Tabs defaultValue="users" className="flex flex-col flex-1 min-h-0">
        ...
        <TabsContent value="console" className="flex-1 flex flex-col min-h-0 mt-4"><ConsoleTab /></TabsContent>
      </Tabs>
    </div>
  );
}
...
function ConsoleTab() {
  ...
  return (
    <Card className="flex flex-col flex-1 min-h-[420px] max-h-[calc(100vh-200px)]">
